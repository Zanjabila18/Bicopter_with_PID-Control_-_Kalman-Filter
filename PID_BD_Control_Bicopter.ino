...
NIM: 181354032
Program PID Control Backward Difference Bicopter (dengan Kalman Filter)
Rabu, 03 Maret 2021
...
//2f. Deklarasi Perhitungan PID-Control
      float Kp, Ti, Ki,Td, Kd, edif, et, et_1, et_2, P, I, D;
      float ut, ut_1, K1, K2, K3, K4;
...
//11g. Hitung Keluaran MV
      ut = ut_1+K3*et-K4*et_1+K2*et_2; 
      MV = ut;
      MV_L = throttle-MV;
      MV_R = throttle+MV;

//11h. Membatasi Output MV
      //Kanan
...
//11j. Menghitung time sampling
//      t_1=t;
//      t=millis();
//      Ts=(t-t_1)/1000;
      
//11k. Cek Penjumlahan Ts
